        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-6 text-white py-14 lg:justify-items-center  ">
            <div>
              ...
              <div className="mt-9 flex items-center space-x-4 hover:text-red-700 transition-all duration-200 ease-in-out cursor-pointer ">
            ...
            <div>
              <div>
                <img
                  src="https://i.postimg.cc/pdhLq7YV/footer.png"
                  alt="footer-img"
                />
              </div>
            </div>
        ...
        <div className="bg-black py-6">
          <div className="container mx-auto">
            <p className="text-white text-center">
              All Rights Reserved by &copy; Academist 2023
            </p>
          </div>
        </div>
      </div>
